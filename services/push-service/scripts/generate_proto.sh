#!/bin/bash
# services/push-service/scripts/generate_proto.sh
# Generate protobuf files for push-service
...
echo -e "${YELLOW}🔧 Generating protobuf files for push-service...${NC}"
...
if [ ! -f "${PROTO_DIR}/push.proto" ]; then
...
# Generate push.proto
echo ""
echo "Generating Go code from push.proto..."
protoc \
