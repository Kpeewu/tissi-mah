...
const (
	...
	PaymentService_GetRefundByBooking_FullMethodName       = "/payment.PaymentService/GetRefundByBooking"
...
type PaymentServiceClient interface {
	...
	// GetRefundByBooking retourne le remboursement (le plus récent) associé à une réservation.
	// Symétrique de GetPaymentByBooking : le client mobile ne connaît pas le RefundId
	// (créé côté backend à l'annulation ou par un worker), seulement le BookingId.
	GetRefundByBooking(ctx context.Context, in *GetRefundByBookingRequest, opts ...grpc.CallOption) (*GetRefundByBookingResponse, error)
...
func (c *paymentServiceClient) GetRefundByBooking(ctx context.Context, in *GetRefundByBookingRequest, opts ...grpc.CallOption) (*GetRefundByBookingResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetRefundByBookingResponse)
	err := c.cc.Invoke(ctx, PaymentService_GetRefundByBooking_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PaymentServiceServer interface {
	...
	// Symétrique de GetPaymentByBooking : le client mobile ne connaît pas le RefundId
	// (créé côté backend à l'annulation ou par un worker), seulement le BookingId.
	GetRefundByBooking(context.Context, *GetRefundByBookingRequest) (*GetRefundByBookingResponse, error)
	// ReleasePayment libère un paiement held après le délai de contestation (interne)
...
func (UnimplementedPaymentServiceServer) GetRefundByBooking(context.Context, *GetRefundByBookingRequest) (*GetRefundByBookingResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetRefundByBooking not implemented")
}
...
func _PaymentService_GetRefundByBooking_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetRefundByBookingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PaymentServiceServer).GetRefundByBooking(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PaymentService_GetRefundByBooking_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).GetRefundByBooking(ctx, req.(*GetRefundByBookingRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PaymentService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetRefundByBooking",
			Handler:    _PaymentService_GetRefundByBooking_Handler,
		},
		{
