// User Service Proto — contrat utilisé par moderation-service
// Définit uniquement GetUserByUserID dont moderation-service a besoin.
...
const file_user_proto_rawDesc = "" +
	...
	"\x06AuthID\x18\x02 \x01(\tR\x06AuthID2Y\n" +
	"\vUserService\x12J\n" +
	"\x0fGetUserByUserID\x12\x1c.user.GetUserByUserIDRequest\x1a\x19.user.UserProfileResponseBQZOgithub.com/Kpeewu/tissi-mah/services/moderation-service/proto/gen/userpb;userpbb\x06proto3"
...
var file_user_proto_depIdxs = []int32{
	0, // 0: user.UserService.GetUserByUserID:input_type -> user.GetUserByUserIDRequest
	1, // 1: user.UserService.GetUserByUserID:output_type -> user.UserProfileResponse
