...
// VehicleInterceptor retourne un intercepteur gRPC unaire.
// Actuellement tous les endpoints sont publics car le user_id est passé dans le body.
...
func VehicleInterceptor() grpc.UnaryServerInterceptor {
