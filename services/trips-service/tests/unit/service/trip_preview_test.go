...
func TestGetTripsPreviews_Fallbacks(t *testing.T) {
	...
	t.Run("user client échoue → driver name vide", func(t *testing.T) {
		...
		vehicleClient.On("GetVehicleInfo", ctx, "driver-1", "vehicle-1").Return("Toyota", "Corolla", "AA", 4, true, nil)
...
func TestGetScheduledTripsPreviews(t *testing.T) {
	t.Run("succès - enrichissement multi-driver", func(t *testing.T) {
		...
		vehicleClient.On("GetVehicleInfo", ctx, "driver-A", "veh-A").Return("Toyota", "Corolla", "AA-1", 4, true, nil)
		vehicleClient.On("GetVehicleInfo", ctx, "driver-B", "veh-B").Return("Honda", "Civic", "BB-2", 4, true, nil)
	...
	t.Run("succès - pagination NextIndex", func(t *testing.T) {
		...
		vehicleClient.On("GetVehicleInfo", ctx, "d1", "v1").Return("T", "M", "P", 4, true, nil)
