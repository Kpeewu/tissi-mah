#!/bin/bash
# services/trips-service/scripts/generate_proto.sh
# Generate protobuf files for trips-service
...
echo -e "${YELLOW}🔧 Generating protobuf files for trips-service...${NC}"
...
if [ ! -f "${PROTO_DIR}/trip.proto" ]; then
