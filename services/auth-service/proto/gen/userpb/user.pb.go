...
const file_user_proto_rawDesc = "" +
	...
	"\x0fGetUserByAuthID\x12\x1c.user.GetUserByAuthIDRequest\x1a\x19.user.UserProfileResponse\x12F\n" +
	"\x0eSoftDeleteUser\x12\x1b.user.SoftDeleteUserRequest\x1a\x17.user.OperationResponseBKZIgithub.com/Kpeewu/tissi-mah/services/auth-service/proto/gen/userpb;userpbb\x06proto3"
...
var file_user_proto_goTypes = []any{
	...
	(*SoftDeleteUserRequest)(nil),  // 2: user.SoftDeleteUserRequest
	(*TripPreference)(nil),         // 3: user.TripPreference
	(*UserProfileResponse)(nil),    // 4: user.UserProfileResponse
	(*OperationResponse)(nil),      // 5: user.OperationResponse
}
var file_user_proto_depIdxs = []int32{
	3, // 0: user.UserProfileResponse.TripPreferences:type_name -> user.TripPreference
	...
	2, // 3: user.UserService.SoftDeleteUser:input_type -> user.SoftDeleteUserRequest
	4, // 4: user.UserService.CreateUser:output_type -> user.UserProfileResponse
	4, // 5: user.UserService.GetUserByAuthID:output_type -> user.UserProfileResponse
	5, // 6: user.UserService.SoftDeleteUser:output_type -> user.OperationResponse
