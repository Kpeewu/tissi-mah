...
// Ce service est inter-service uniquement (pas d'exposition HTTP via api-gateway)
// Il gère l'upload de fichiers vers S3/MinIO et le stockage des métadonnées
...
const file_file_proto_rawDesc = "" +
	...
	"\ttimestamp\x18\x03 \x01(\x03R\ttimestamp2\xec\a\n" +
	"\vFileService\x12S\n" +
	"\x12UploadUserDocument\x12\x1f.file.UploadUserDocumentRequest\x1a\x1a.file.UserDocumentResponse(\x01\x12\\\n" +
	"\x15UploadVehicleDocument\x12\".file.UploadVehicleDocumentRequest\x1a\x1d.file.VehicleDocumentResponse(\x01\x12Q\n" +
...
var file_file_proto_goTypes = []any{
	(*UploadUserDocumentRequest)(nil),     // 0: file.UploadUserDocumentRequest
	(*UserDocumentMetadata)(nil),          // 1: file.UserDocumentMetadata
	(*UploadVehicleDocumentRequest)(nil),  // 2: file.UploadVehicleDocumentRequest
	(*VehicleDocumentMetadata)(nil),       // 3: file.VehicleDocumentMetadata
	(*GetUserDocumentsRequest)(nil),       // 4: file.GetUserDocumentsRequest
	(*GetDocumentByIDRequest)(nil),        // 5: file.GetDocumentByIDRequest
	(*GetCurrentUserDocumentRequest)(nil), // 6: file.GetCurrentUserDocumentRequest
	(*GetVehicleDocumentsRequest)(nil),    // 7: file.GetVehicleDocumentsRequest
	(*DeleteDocumentRequest)(nil),         // 8: file.DeleteDocumentRequest
	(*CreateDocumentReviewRequest)(nil),   // 9: file.CreateDocumentReviewRequest
	(*GetDocumentReviewsRequest)(nil),     // 10: file.GetDocumentReviewsRequest
	(*HealthRequest)(nil),                 // 11: file.HealthRequest
	(*UserDocumentResponse)(nil),          // 12: file.UserDocumentResponse
	(*VehicleDocumentResponse)(nil),       // 13: file.VehicleDocumentResponse
	(*GetUserDocumentsResponse)(nil),      // 14: file.GetUserDocumentsResponse
	(*GetVehicleDocumentsResponse)(nil),   // 15: file.GetVehicleDocumentsResponse
	(*OperationResponse)(nil),             // 16: file.OperationResponse
	(*DocumentReviewResponse)(nil),        // 17: file.DocumentReviewResponse
	(*GetDocumentReviewsResponse)(nil),    // 18: file.GetDocumentReviewsResponse
	(*HealthResponse)(nil),                // 19: file.HealthResponse
}
var file_file_proto_depIdxs = []int32{
	1,  // 0: file.UploadUserDocumentRequest.metadata:type_name -> file.UserDocumentMetadata
	3,  // 1: file.UploadVehicleDocumentRequest.metadata:type_name -> file.VehicleDocumentMetadata
	12, // 2: file.GetUserDocumentsResponse.documents:type_name -> file.UserDocumentResponse
	13, // 3: file.GetVehicleDocumentsResponse.documents:type_name -> file.VehicleDocumentResponse
	17, // 4: file.GetDocumentReviewsResponse.reviews:type_name -> file.DocumentReviewResponse
	0,  // 5: file.FileService.UploadUserDocument:input_type -> file.UploadUserDocumentRequest
	2,  // 6: file.FileService.UploadVehicleDocument:input_type -> file.UploadVehicleDocumentRequest
	4,  // 7: file.FileService.GetUserDocuments:input_type -> file.GetUserDocumentsRequest
	5,  // 8: file.FileService.GetUserDocument:input_type -> file.GetDocumentByIDRequest
	6,  // 9: file.FileService.GetCurrentUserDocument:input_type -> file.GetCurrentUserDocumentRequest
	7,  // 10: file.FileService.GetVehicleDocuments:input_type -> file.GetVehicleDocumentsRequest
	5,  // 11: file.FileService.GetVehicleDocument:input_type -> file.GetDocumentByIDRequest
	8,  // 12: file.FileService.DeleteUserDocument:input_type -> file.DeleteDocumentRequest
	8,  // 13: file.FileService.DeleteVehicleDocument:input_type -> file.DeleteDocumentRequest
	9,  // 14: file.FileService.CreateDocumentReview:input_type -> file.CreateDocumentReviewRequest
	10, // 15: file.FileService.GetDocumentReviews:input_type -> file.GetDocumentReviewsRequest
	11, // 16: file.FileService.Health:input_type -> file.HealthRequest
	12, // 17: file.FileService.UploadUserDocument:output_type -> file.UserDocumentResponse
	13, // 18: file.FileService.UploadVehicleDocument:output_type -> file.VehicleDocumentResponse
	14, // 19: file.FileService.GetUserDocuments:output_type -> file.GetUserDocumentsResponse
	12, // 20: file.FileService.GetUserDocument:output_type -> file.UserDocumentResponse
	12, // 21: file.FileService.GetCurrentUserDocument:output_type -> file.UserDocumentResponse
	15, // 22: file.FileService.GetVehicleDocuments:output_type -> file.GetVehicleDocumentsResponse
	13, // 23: file.FileService.GetVehicleDocument:output_type -> file.VehicleDocumentResponse
	16, // 24: file.FileService.DeleteUserDocument:output_type -> file.OperationResponse
	16, // 25: file.FileService.DeleteVehicleDocument:output_type -> file.OperationResponse
	17, // 26: file.FileService.CreateDocumentReview:output_type -> file.DocumentReviewResponse
	18, // 27: file.FileService.GetDocumentReviews:output_type -> file.GetDocumentReviewsResponse
	19, // 28: file.FileService.Health:output_type -> file.HealthResponse
