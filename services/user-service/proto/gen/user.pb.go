...
const file_user_proto_rawDesc = "" +
	...
	"\tTimestamp\x18\x03 \x01(\x03R\tTimestamp2\xb4\a\n" +
	"\vUserService\x12@\n" +
	"\n" +
	...
	"\x0fGetUserByUserID\x12\x1c.user.GetUserByUserIDRequest\x1a\x19.user.UserProfileResponse\x12a\n" +
...
var file_user_proto_goTypes = []any{
	...
	(*CreateDriverAccountRequest)(nil),   // 4: user.CreateDriverAccountRequest
	(*AddTripPreferencesRequest)(nil),    // 5: user.AddTripPreferencesRequest
	(*UpdateProfileRequest)(nil),         // 6: user.UpdateProfileRequest
	(*HealthRequest)(nil),                // 7: user.HealthRequest
	(*TripPreference)(nil),               // 8: user.TripPreference
	(*UserProfileResponse)(nil),          // 9: user.UserProfileResponse
	(*GetMyProfileResponse)(nil),         // 10: user.GetMyProfileResponse
	(*FullUserProfile)(nil),              // 11: user.FullUserProfile
	(*UserFile)(nil),                     // 12: user.UserFile
	(*OperationResponse)(nil),            // 13: user.OperationResponse
	(*UpdateProfileResponse)(nil),        // 14: user.UpdateProfileResponse
	(*ChangeProfilePictureRequest)(nil),  // 15: user.ChangeProfilePictureRequest
	(*ChangeProfilePictureResponse)(nil), // 16: user.ChangeProfilePictureResponse
	(*HealthResponse)(nil),               // 17: user.HealthResponse
}
var file_user_proto_depIdxs = []int32{
	8,  // 0: user.AddTripPreferencesRequest.Preferences:type_name -> user.TripPreference
	...
	11, // 5: user.ChangeProfilePictureResponse.User:type_name -> user.FullUserProfile
	...
	15, // 13: user.UserService.ChangeProfilePicture:input_type -> user.ChangeProfilePictureRequest
	7,  // 14: user.UserService.Health:input_type -> user.HealthRequest
	9,  // 15: user.UserService.CreateUser:output_type -> user.UserProfileResponse
	9,  // 16: user.UserService.GetUserByAuthID:output_type -> user.UserProfileResponse
	9,  // 17: user.UserService.GetUserByUserID:output_type -> user.UserProfileResponse
	10, // 18: user.UserService.GetMyProfile:output_type -> user.GetMyProfileResponse
	13, // 19: user.UserService.CreateDriverAccount:output_type -> user.OperationResponse
	13, // 20: user.UserService.AddTripPreferences:output_type -> user.OperationResponse
	14, // 21: user.UserService.UpdateProfile:output_type -> user.UpdateProfileResponse
	16, // 22: user.UserService.ChangeProfilePicture:output_type -> user.ChangeProfilePictureResponse
	17, // 23: user.UserService.Health:output_type -> user.HealthResponse
