...
const file_user_proto_rawDesc = "" +
	...
	"\x06AuthID\x18\x01 \x01(\tR\x06AuthID\"0\n" +
	...
	"\tTimestamp\x18\x03 \x01(\x03R\tTimestamp2\xfc\a\n" +
	"\vUserService\x12@\n" +
	"\n" +
	"CreateUser\x12\x17.user.CreateUserRequest\x1a\x19.user.UserProfileResponse\x12J\n" +
	"\x0fGetUserByAuthID\x12\x1c.user.GetUserByAuthIDRequest\x1a\x19.user.UserProfileResponse\x12J\n" +
...
var file_user_proto_goTypes = []any{
	...
	(*GetUserByUserIDRequest)(nil),       // 2: user.GetUserByUserIDRequest
	(*SoftDeleteUserRequest)(nil),        // 3: user.SoftDeleteUserRequest
	(*GetMyProfileRequest)(nil),          // 4: user.GetMyProfileRequest
	(*CreateDriverAccountRequest)(nil),   // 5: user.CreateDriverAccountRequest
	(*AddTripPreferencesRequest)(nil),    // 6: user.AddTripPreferencesRequest
	(*UpdateProfileRequest)(nil),         // 7: user.UpdateProfileRequest
	(*HealthRequest)(nil),                // 8: user.HealthRequest
	(*TripPreference)(nil),               // 9: user.TripPreference
	(*UserProfileResponse)(nil),          // 10: user.UserProfileResponse
	(*GetMyProfileResponse)(nil),         // 11: user.GetMyProfileResponse
	(*FullUserProfile)(nil),              // 12: user.FullUserProfile
	(*UserFile)(nil),                     // 13: user.UserFile
	(*OperationResponse)(nil),            // 14: user.OperationResponse
	(*UpdateProfileResponse)(nil),        // 15: user.UpdateProfileResponse
	(*ChangeProfilePictureRequest)(nil),  // 16: user.ChangeProfilePictureRequest
	(*ChangeProfilePictureResponse)(nil), // 17: user.ChangeProfilePictureResponse
	(*HealthResponse)(nil),               // 18: user.HealthResponse
}
var file_user_proto_depIdxs = []int32{
	9,  // 0: user.AddTripPreferencesRequest.Preferences:type_name -> user.TripPreference
	9,  // 1: user.UserProfileResponse.TripPreferences:type_name -> user.TripPreference
	12, // 2: user.GetMyProfileResponse.User:type_name -> user.FullUserProfile
	9,  // 3: user.FullUserProfile.TripPreferences:type_name -> user.TripPreference
	12, // 4: user.UpdateProfileResponse.User:type_name -> user.FullUserProfile
	12, // 5: user.ChangeProfilePictureResponse.User:type_name -> user.FullUserProfile
	...
	3,  // 9: user.UserService.SoftDeleteUser:input_type -> user.SoftDeleteUserRequest
	4,  // 10: user.UserService.GetMyProfile:input_type -> user.GetMyProfileRequest
	5,  // 11: user.UserService.CreateDriverAccount:input_type -> user.CreateDriverAccountRequest
	6,  // 12: user.UserService.AddTripPreferences:input_type -> user.AddTripPreferencesRequest
	7,  // 13: user.UserService.UpdateProfile:input_type -> user.UpdateProfileRequest
	16, // 14: user.UserService.ChangeProfilePicture:input_type -> user.ChangeProfilePictureRequest
	8,  // 15: user.UserService.Health:input_type -> user.HealthRequest
	10, // 16: user.UserService.CreateUser:output_type -> user.UserProfileResponse
	10, // 17: user.UserService.GetUserByAuthID:output_type -> user.UserProfileResponse
	10, // 18: user.UserService.GetUserByUserID:output_type -> user.UserProfileResponse
	14, // 19: user.UserService.SoftDeleteUser:output_type -> user.OperationResponse
	11, // 20: user.UserService.GetMyProfile:output_type -> user.GetMyProfileResponse
	14, // 21: user.UserService.CreateDriverAccount:output_type -> user.OperationResponse
	14, // 22: user.UserService.AddTripPreferences:output_type -> user.OperationResponse
	15, // 23: user.UserService.UpdateProfile:output_type -> user.UpdateProfileResponse
	17, // 24: user.UserService.ChangeProfilePicture:output_type -> user.ChangeProfilePictureResponse
	18, // 25: user.UserService.Health:output_type -> user.HealthResponse
