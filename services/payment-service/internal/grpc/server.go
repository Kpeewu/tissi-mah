...
// NewPaymentServer crée et configure le serveur gRPC de payment-service.
func NewPaymentServer(
	...
	paymentpb.RegisterPaymentServiceServer(srv.Server(), handler)
	srv.SetServingStatus("payment.PaymentService", grpc_health_v1.HealthCheckResponse_SERVING)
