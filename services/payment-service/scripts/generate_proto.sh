#!/bin/bash
# services/payment-service/scripts/generate_proto.sh
# Generate protobuf files for payment-service
...
echo -e "${YELLOW}🔧 Generating protobuf files for payment-service...${NC}"
...
if [ ! -f "${PROTO_DIR}/payment.proto" ]; then
